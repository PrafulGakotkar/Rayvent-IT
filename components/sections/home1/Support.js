                        ...
                        <div className="col-lg-6 col-md-12 col-sm-12 content-column">
                            <div className="content_block_one">
                                <div className="content-box p_relative ml_30 mb_30">
                                    ...
                                    <Link href="/outsourcing-manages-services" className="theme-btn-one">Read More</Link>
                                </div>
                        ...
                        <div className="col-lg-6 col-md-12 col-sm-12 image-column">
                            <div className="image_block_one">
                                <div className="image-box p_relative pr_50 mr_30" style={{ padding: 0 }}>
                                    <figure className="image image-1"><img src="assets/images/resource/managed-services.jpg" alt="" /></figure>
                ...
                <div className="auto-container">
                    <div className="row clearfix">
                        <div className="col-lg-6 col-md-12 col-sm-12 image-column">
                            <div className="image_block_one">
                                <div className="image-box p_relative pr_50 mr_30" style={{ padding: 0 }}>
                                    <figure className="image image-1"><img src="assets/images/resource/flex.jpg" alt="" /></figure>
                        ...
                        <div className="col-lg-6 col-md-12 col-sm-12 content-column">
                            <div className="content_block_one">
                                <div className="content-box p_relative ml_30 mb_30">
                                    ...
                                    <Link href="/flex-support" className="theme-btn-one">Read More</Link>
                                </div>
                        ...
                        <div className="col-lg-4 col-md-12 col-sm-12 content-column">
                            <div className="content_block_one">
                                <div className="content-box p_relative ml_30 mb_30">
                                    <div className="sec-title mb_25">
                                        {/* <span className="sub-title">About BizTech</span> */}
                                        <h3>Full Life Cycle Development</h3>
                                    </div>
                                    <div className="text mb_35">
                                        <ul className="list-style-one clearfix">
