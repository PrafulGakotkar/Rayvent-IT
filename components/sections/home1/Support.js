                        ...
                        <div className="col-lg-6 col-md-12 col-sm-12 image-column">
                            <div className="image_block_one">
                                <div className="image-box p_relative pr_50 mr_30" style={{ padding: 0 }}>
                                    <figure className="image image-1"><img src="assets/images/resource/managed-services.png" alt="" /></figure>
                ...
                <div className="auto-container">
                    <div className="row clearfix">
                        <div className="col-lg-6 col-md-12 col-sm-12 image-column">
                            <div className="image_block_one">
                                <div className="image-box p_relative pr_50 mr_30" style={{ padding: 0 }}>
                                    <figure className="image image-1"><img src="assets/images/resource/flex.png" alt="" /></figure>
